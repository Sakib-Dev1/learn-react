...
function App() {
  ...
  return (
    <div >
      <h2>Learn React</h2>
      <FoodDish recepieImg={recepieDetails[0].img}recepieTitle={recepieDetails[0].recepieName} recepiePrice={recepieDetails[0].price}/>
      <FoodDish recepieImg={recepieDetails[1].img} recepieTitle={recepieDetails[1].recepieName}  recepiePrice={recepieDetails[1].price}/>
      <FoodDish recepieImg={recepieDetails[2].img} recepieTitle={recepieDetails[2].recepieName} recepiePrice={recepieDetails[2].price}/>
    </div>
  );
}
